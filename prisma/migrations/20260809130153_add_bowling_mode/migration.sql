...
CREATE TABLE "new_Match" (
    ...
    "bowlingMode" TEXT NOT NULL DEFAULT 'NORMAL',
    "oversPerInnings" INTEGER NOT NULL,
    "inningsPerMatch" INTEGER NOT NULL DEFAULT 2,
...
INSERT INTO "new_Match" ("createdAt", "id", "inningsPerMatch", "matchNumber", "oddOvers", "oversPerInnings", "playersPerTeam", "scheduledAt", "status", "teamAId", "teamBId", "tossDecision", "tossWinnerId", "tournamentId", "updatedAt", "venue", "winnerId") SELECT "createdAt", "id", "inningsPerMatch", "matchNumber", "oddOvers", "oversPerInnings", "playersPerTeam", "scheduledAt", "status", "teamAId", "teamBId", "tossDecision", "tossWinnerId", "tournamentId", "updatedAt", "venue", "winnerId" FROM "Match";
DROP TABLE "Match";
