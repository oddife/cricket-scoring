...
const [loadingCompletedMatches, setLoadingCompletedMatches] =
  useState(false);
        ...
        <div className="mt-5 rounded-2xl border border-slate-800 bg-slate-950/70 p-6 [color-scheme:dark]">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-500">
                Matches for this tournament will
                appear here.
              </p>
            </div>
          </div>
          ...
          {selectedTournament._count.matches ===
            ...
            <div className="mt-5 rounded-xl border border-dashed border-slate-800 p-6 text-center [color-scheme:dark]">
              ...
              <button
                ...
                onClick={openMatchSetup}
                className="mt-4 rounded-xl bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-slate-950 hover:bg-emerald-4
00 disabled:cursor-not-allowed disabled:bg-slate-800 disabled:text-slate-600"
              >
                {selectedTournament.teams
                  .length < 2
                  ? "Add 2 Teams First"
